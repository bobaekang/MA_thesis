...
## 1. Downloading and unzipping raw data sets from Divvy and     ##
## CTA that are necessary for the current project and used in    ##
## the scripts that follow this.                                 ##
##---------------------------------------------------------------##
...
file.rename(from = "rawdata/Divvy_Trips_2016_Q1Q2/README.txt", to = "rawdata/Divvy_Trips_2016_Q1Q2/README_2016_Q1Q2.txt")
